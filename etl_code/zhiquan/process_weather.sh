...
hdfs dfs -mv /user/evc252/shared_data/spark_output/clean_weather/*.csv shared_data/clean/clean_weather.csv

# copy data to local
hdfs dfs -copyToLocal /user/evc252/shared_data/clean/clean_weather.csv ~/Top-Towns-To-Take-Over-Tech/data/clean_weather